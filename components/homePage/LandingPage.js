          ...
          <div className="absolute bottom-2 sm:bottom-4 w-full mx-auto ">
            <div className="text-center h-fit mb-4 text-white tracking-wider">
              <h1 className="bg-black/80 text-lg sm:text-2xl w-full mx-auto p-4 font-semibold my-2 ">
                ...
                <div className="my-2 font-bold text-lg">
                  All Selected and presented Papers will be uploaded on the IEEE
                  Xplore
                </div>
              </h1>

              <h1 className="bg-black/80 text-sm sm:text-xl w-full mx-auto p-5 m-2 ">
                This is the 2nd draft of the updated programme schedule and will
                be updated from time to time. Hence, applicants are kindly
                requested to keep on viewing in regular intervals. In case of
                any query, please drop an email to{" "}
                <a
                ...
                .
                <p className="blue-300">
                  {" "}
                  <a
                    href="..\docs\PROGRAM_SCHEDULE_2.pdf"
                    className="text-blue-500"
                  >
                    Updated/ 2nd Draft of Tentative Programme Schedule
                  </a>{" "}
                </p>
              </h1>
              <h1 className="bg-black/80 text-sm sm:text-xl w-full mx-auto p-5 m-2 ">
                NIT Delhi will not be able to provide any accommodation during
                the ICECSP 2024 conference, however, for the convenience of
                participants, details of few nearby hotels are enlisted in the
                accommodation page on this website (Website --&gt;
                Accommodations).
              </h1>
              <h1 className="bg-black/80 text-sm sm:text-xl w-full mx-auto p-5 m-2 ">
              Dear Participants,
...
The ICECSP 2024 Programme Committee decided to provide Track wise “Best Paper Award (One Best paper for individual tracks)" based on the performance evaluation by the Respective Session Chair and the Programme Committee to encourage the participants.
